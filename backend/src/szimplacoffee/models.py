...
class Product(Base):
    ...
    origin_country_source: Mapped[str] = mapped_column(String(32), default="unknown")
    ...
    process_family_confidence: Mapped[float] = mapped_column(Float, default=0.0)
    process_family_source: Mapped[str] = mapped_column(String(32), default="unknown")
    ...
    roast_level_confidence: Mapped[float] = mapped_column(Float, default=0.0)
    roast_level_source: Mapped[str] = mapped_column(String(32), default="unknown")
...
class ProductMetadataOverride(Base):
    ...
    origin_country_confidence: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    origin_country_source: Mapped[Optional[str]] = mapped_column(String(32), nullable=True)
    origin_region: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    process_text: Mapped[str] = mapped_column(Text, default="")
    process_family: Mapped[str] = mapped_column(String(32), default="unknown")
    process_family_confidence: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    process_family_source: Mapped[Optional[str]] = mapped_column(String(32), nullable=True)
    variety_text: Mapped[str] = mapped_column(Text, default="")
    roast_cues: Mapped[str] = mapped_column(Text, default="")
    roast_level: Mapped[str] = mapped_column(String(32), default="unknown")
    roast_level_confidence: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    roast_level_source: Mapped[Optional[str]] = mapped_column(String(32), nullable=True)
    tasting_notes_text: Mapped[str] = mapped_column(Text, default="")
